    ...
    <div className="w-full">
      ...
      <section className="bg-[#F1F8FC] py-16 md:py-24 border-b border-[#8FC7E6]/50">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8 text-center max-w-3xl">
          ...
          <h1 className="font-display text-[38px] md:text-[54px] font-medium text-[#4496CC] mb-6 leading-tight">
            La Maison <em className="font-display italic text-[#2F7EAF] font-normal">Louise XIV</em>
          </h1>

          <p className="font-body text-[16px] md:text-[18px] font-light text-[#2F7EAF] leading-relaxed mb-8">
      ...
      {/* SECTION 2: NOTRE HISTOIRE (Background #E3F1F8 - Surface) */}
      <section id="histoire" className="bg-[#E3F1F8] py-20 border-b border-[#8FC7E6]/50 scroll-mt-20">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="flex items-center gap-2 text-[#4496CC]">
                <Users size={18} strokeWidth={1.5} />
                <span className="font-body text-[11px] uppercase tracking-[0.15em] font-semibold">Origines &amp; Transmission</span>
              </div>

              <h2 className="font-display text-[28px] sm:text-[34px] font-medium text-[#1F3F52]">
                Notre <em className="font-display italic text-[#4496CC] font-normal">Histoire</em>
              </h2>

              <p className="font-body text-[14.5px] font-light text-[#2F7EAF] leading-relaxed">
      ...
      {/* SECTION 3: NOS ENGAGEMENTS (Background #F1F8FC) */}
      <section id="engagements" className="bg-[#F1F8FC] py-20 border-b border-[#8FC7E6]/50 scroll-mt-20">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
      ...
      {/* SECTION 4: INNOVATION SUISSE (Background #E3F1F8 - Surface, alternating rhythm) */}
      <section id="innovation" className="bg-[#E3F1F8] py-20 border-b border-[#8FC7E6]/50 scroll-mt-20">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <h2 className="font-display text-[28px] sm:text-[34px] font-medium text-[#1F3F52]">
                L&apos;Apothicairerie <em className="font-display italic text-[#4496CC] font-normal">Innovante</em>
              </h2>
            ...
            <div className="lg:col-span-5">
              <div className="relative aspect-[4/3] sm:aspect-[16/10] lg:aspect-square rounded-none overflow-hidden border border-[#8FC7E6]">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
      ...
      {/* SECTION 5: CONTACT BLOCK & FORM (Background #F1F8FC) */}
      <section id="contact" className="bg-[#F1F8FC] py-20 border-b border-[#8FC7E6]/50 scroll-mt-20">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-8 bg-[#E3F1F8] p-8 rounded-none border border-[#8FC7E6] shadow-none">
              
              <div>
                <h3 className="font-display text-[20px] font-medium text-[#1F3F52] mb-4">
                  Le Salon &amp; Showroom
                </h3>
                <p className="font-body text-[13.5px] font-light text-[#2F7EAF] leading-relaxed mb-6">
              ...
              <div className="space-y-4 font-body text-[13.5px] text-[#2F7EAF]">
                <div className="flex items-start gap-3">
                  <MapPin size={18} strokeWidth={1.5} className="text-[#4496CC] mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-[#1F3F52]">Maison Louise XIV — Genève</p>
                    <p className="font-light">Rue du Rhône 14, 1204 Genève, Suisse</p>
                  </div>
                </div>

                <div className="flex items-center gap-3">
                  <Phone size={18} strokeWidth={1.5} className="text-[#4496CC] flex-shrink-0" />
                  <p className="font-light">+41 (0) 22 546 89 90</p>
                </div>

                <div className="flex items-center gap-3">
                  <Mail size={18} strokeWidth={1.5} className="text-[#4496CC] flex-shrink-0" />
            ...
            {/* Right: Contact Form */}
            <div className="lg:col-span-7 bg-[#F1F8FC] p-8 rounded-[10px] border border-[#8FC7E6] shadow-xs">
              <h3 className="font-display text-[20px] font-medium text-[#1F3F52] mb-6">
                Écrire à <em className="font-display italic text-[#4496CC] font-normal">notre laboratoire</em>
              </h3>

              <form onSubmit={handleFormSubmit} className="space-y-5 font-body">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label htmlFor="name" className="block text-[12px] font-semibold uppercase tracking-wider text-[#2F7EAF] mb-2">
                      Nom Complet
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="email" className="block text-[12px] font-semibold uppercase tracking-wider text-[#2F7EAF] mb-2">
                      Adresse Email
                    </label>
                    <input
                      type="email"
                ...
                <div>
                  <label htmlFor="subject" className="block text-[12px] font-semibold uppercase tracking-wider text-[#2F7EAF] mb-2">
                ...
                <div>
                  <label htmlFor="message" className="block text-[12px] font-semibold uppercase tracking-wider text-[#2F7EAF] mb-2">
                    Message
                  </label>
                  <textarea
                    id="message"
