    ...
    <div className="w-full">
      ...
      <section className="bg-[#FFFAFA] py-16 md:py-24 border-b border-[#E8D8CC]/50">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8 text-center max-w-3xl">
          <div className="inline-flex items-center justify-center gap-2 border border-[#C9AA95]/40 bg-[#F8F0EB] px-3 py-1 rounded-none mb-6">
            <Crown size={14} strokeWidth={1.5} className="text-[#7A5C46]" />
          ...
          <h1 className="font-display text-[38px] md:text-[54px] font-medium text-[#573119] mb-6 leading-tight">
            La Maison <em className="font-display italic text-[#7A5C46] font-normal">Louise XIV</em>
          </h1>

          <p className="font-body text-[16px] md:text-[18px] font-light text-[#7A5C46] leading-relaxed mb-8">
          ...
          <div className="w-16 h-[1px] bg-[#C9AA95] mx-auto"></div>
        </div>
      </section>

      {/* SECTION 2: NOTRE HISTOIRE (Background #F8F0EB - Surface) */}
      <section id="histoire" className="bg-[#F8F0EB] py-20 border-b border-[#E8D8CC]/50 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative aspect-[4/5] rounded-none overflow-hidden border border-[#E8D8CC] shadow-none">
                ...
                />
                <div className="absolute bottom-4 left-4 right-4 bg-[#FFFAFA]/95 border border-[#C9AA95] p-3 rounded-none text-center">
                  <p className="font-display italic text-[14px] text-[#573119]">Eugénia M.</p>
                  <p className="font-body text-[9px] uppercase tracking-widest text-[#7A5C46]">Fondatrice &amp; Maître Trichologue</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <h2 className="font-display text-[28px] sm:text-[34px] font-medium text-[#2C1A0E]">
              ...
              <div className="border-l-2 border-[#C9AA95] pl-4 py-1 italic font-display text-[15px] text-[#573119] font-medium">
      ...
      <section id="engagements" className="bg-[#FFFAFA] py-20 border-b border-[#E8D8CC]/50 scroll-mt-20">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#F8F0EB] p-8 rounded-none border border-[#E8D8CC] shadow-none hover:bg-[#F2E6DC] transition-all duration-300">
              <div className="w-12 h-12 rounded-none bg-[#EAF0E6] flex items-center justify-center text-[#6B8F5E] mb-6">
                <Sprout size={24} strokeWidth={1.5} />
              </div>
              <h3 className="font-display text-[18px] font-medium text-[#2C1A0E] mb-3">Pureté Biologique</h3>
              <p className="font-body text-[13.5px] font-light text-[#7A5C46] leading-relaxed">
            ...
            <div className="bg-[#F8F0EB] p-8 rounded-none border border-[#E8D8CC] shadow-none hover:bg-[#F2E6DC] transition-all duration-300">
              <div className="w-12 h-12 rounded-none bg-[#EAF0E6] flex items-center justify-center text-[#6B8F5E] mb-6">
                <Award size={24} strokeWidth={1.5} className="text-[#6B8F5E]" />
              </div>
              <h3 className="font-display text-[18px] font-medium text-[#2C1A0E] mb-3">Fabrication Suisse</h3>
              <p className="font-body text-[13.5px] font-light text-[#7A5C46] leading-relaxed">
            ...
            <div className="bg-[#F8F0EB] p-8 rounded-none border border-[#E8D8CC] shadow-none hover:bg-[#F2E6DC] transition-all duration-300">
              ...
              <h3 className="font-display text-[18px] font-medium text-[#2C1A0E] mb-3">Transparence Totale</h3>
              <p className="font-body text-[13.5px] font-light text-[#7A5C46] leading-relaxed">
      ...
      <section id="innovation" className="bg-[#F8F0EB] py-20 border-b border-[#E8D8CC]/50 scroll-mt-20">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6 pt-4">
                <div className="flex gap-2">
                  <Check size={16} strokeWidth={1.5} className="text-[#6B8F5E] mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-display text-[14px] font-semibold text-[#2C1A0E]">Tests sous contrôle dermatologique</h4>
                  </div>
                </div>
                <div className="flex gap-2">
                  <Check size={16} strokeWidth={1.5} className="text-[#6B8F5E] mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-display text-[14px] font-semibold text-[#2C1A0E]">Flacons recyclables sans phtalates</h4>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5">
              <div className="relative aspect-[4/3] sm:aspect-[16/10] lg:aspect-square rounded-none overflow-hidden border border-[#E8D8CC]">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
      ...
      <section id="contact" className="bg-[#FFFAFA] py-20 border-b border-[#E8D8CC]/50 scroll-mt-20">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-8 bg-[#F8F0EB] p-8 rounded-none border border-[#E8D8CC] shadow-none">
              
              <div>
                <h3 className="font-display text-[20px] font-medium text-[#2C1A0E] mb-4">
                  Le Salon &amp; Showroom
                </h3>
                <p className="font-body text-[13.5px] font-light text-[#7A5C46] leading-relaxed mb-6">
              ...
              <div className="space-y-4 font-body text-[13.5px] text-[#7A5C46]">
                <div className="flex items-start gap-3">
                  <MapPin size={18} strokeWidth={1.5} className="text-[#573119] mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-[#2C1A0E]">Maison Louise XIV — Genève</p>
                ...
                <div className="flex items-start gap-3 pt-2 border-t border-[#C9AA95]/20">
                  <Clock size={18} strokeWidth={1.5} className="text-[#573119] mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-[#2C1A0E]">Heures d&apos;Ouverture</p>
                    <p className="font-light">Lundi - Vendredi : 09:00 - 19:00</p>
                    <p className="font-light">Samedi : 10:00 - 18:00</p>
                    <p className="font-light text-[#B09880] mt-1">Sur rendez-vous uniquement</p>
                  </div>
                </div>
              </div>
            ...
            {/* Right: Contact Form */}
            <div className="lg:col-span-7 bg-[#FFFAFA] p-8 rounded-[10px] border border-[#E8D8CC] shadow-xs">
              <h3 className="font-display text-[20px] font-medium text-[#2C1A0E] mb-6">
              ...
              <form onSubmit={handleFormSubmit} className="space-y-5 font-body">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label htmlFor="name" className="block text-[12px] font-semibold uppercase tracking-wider text-[#7A5C46] mb-2">
                      Nom Complet
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full bg-[#FFFFFF] border border-[#C9AA95] text-[#2C1A0E] text-[13px] px-3.5 py-2.5 rounded-none focus:outline-none focus:border-[#573119]"
                  ...
                  <div>
                    <label htmlFor="email" className="block text-[12px] font-semibold uppercase tracking-wider text-[#7A5C46] mb-2">
                      Adresse Email
                    </label>
                    <input
                      type="email"
                ...
                <div>
                  <label htmlFor="subject" className="block text-[12px] font-semibold uppercase tracking-wider text-[#7A5C46] mb-2">
                ...
                <div>
                  <label htmlFor="message" className="block text-[12px] font-semibold uppercase tracking-wider text-[#7A5C46] mb-2">
                    Message
                  </label>
                  <textarea
                    id="message"
                    ...
                    onChange={handleInputChange}
                    className="w-full bg-[#FFFFFF] border border-[#C9AA95] text-[#2C1A0E] text-[13px] px-3.5 py-2.5 rounded-none focus:outline-none focus:border-[#573119] resize-none"
                ...
                {submitted && (
                  <div className="p-4 bg-[#EAF0E6] text-[#6B8F5E] rounded-none flex items-center gap-2 border border-[#6B8F5E]/20 animate-fade-in">
                    <Check size={18} />
