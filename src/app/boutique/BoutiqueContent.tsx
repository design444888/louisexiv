...
export default function BoutiqueContent() {
  ...
  return (
    <div className="w-full">
      ...
      <section className="bg-[#FFFAFA] py-16 md:py-24 border-b border-[#E8D8CC]/50">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8 text-center space-y-6">
          ...
          <h1 className="font-display text-[38px] md:text-[54px] font-medium text-[#573119] leading-tight">
            Boutique <em className="font-display italic text-[#7A5C46] font-normal">Louise XIV</em>
          </h1>
          
          <p className="font-body text-[15px] sm:text-[16px] font-light text-[#7A5C46] max-w-xl mx-auto leading-relaxed">
      ...
      <section id="colorations" className="bg-[#FFFAFA] py-20 border-b border-[#E8D8CC]/50 scroll-mt-32">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
          
          <div className="text-center max-w-xl mx-auto mb-16">
            <span className="font-body text-[11px] uppercase tracking-[0.15em] text-[#7A5C46] flex items-center justify-center gap-2">
            ...
            <p className="font-body text-[14px] font-light text-[#7A5C46] mt-2 leading-relaxed">
      ...
      <section id="soins" className="bg-[#F8F0EB] py-20 border-b border-[#E8D8CC]/50 scroll-mt-32">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
      ...
      <section id="accessoires" className="bg-[#F8F0EB] py-20 border-b border-[#E8D8CC]/50 scroll-mt-32">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
