    ...
    <div className="w-full">
      ...
      <section className="bg-[#FFFAFA] py-16 md:py-24 border-b border-[#E4D3C8]/50">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8 text-center space-y-6">
          ...
          <h1 className="font-display text-[38px] md:text-[54px] font-medium text-[#573119] leading-tight">
            Boutique <em className="font-display italic text-[#6E4226] font-normal">Louise XIV</em>
          </h1>
          
          <p className="font-body text-[15px] sm:text-[16px] font-light text-[#6E4226] max-w-xl mx-auto leading-relaxed">
      ...
      <section className={`bg-[#F8F0EB] border-b border-[#E4D3C8]/50 py-5 sticky top-20 z-40 shadow-xs transition-all duration-500 ease-in-out ${isScrolled ? 'opacity-70 hover:opacity-100' : 'opacity-100'}`}>
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
          <div className="flex items-center justify-start md:justify-center gap-6 md:gap-8 overflow-x-auto no-scrollbar whitespace-nowrap font-body text-[12px] font-semibold uppercase tracking-wider text-[#6E4226]">
            <a 
              href="#colorations" 
              onClick={(e) => scrollToSection(e, 'colorations')}
              className="px-2 py-1.5 hover:text-[#6E4226] text-[#573119] transition-all cursor-pointer flex items-center gap-2 flex-shrink-0 hover:scale-102 hover:underline underline-offset-[6px]"
            >
      ...
      {/* SECTION 3: COLORATIONS NATURELLES (Background #FFFAFA - white cream) */}
      <section id="colorations" className="bg-[#FFFAFA] py-20 border-b border-[#E4D3C8]/50 scroll-mt-32">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
          
          <div className="text-center max-w-xl mx-auto mb-16">
            <span className="font-body text-[11px] uppercase tracking-[0.15em] text-[#6E4226] flex items-center justify-center gap-2">
            ...
            <h2 className="font-display text-[28px] sm:text-[34px] font-medium text-[#402312] mt-2 leading-tight">
              Colorations <em className="font-display italic text-[#573119] font-normal">Naturelles</em>
            </h2>
            <p className="font-body text-[14px] font-light text-[#6E4226] mt-2 leading-relaxed">
      ...
      {/* SECTION 4: SOINS CAPILLAIRES (Background #F8F0EB - soft crème) */}
      <section id="soins" className="bg-[#F8F0EB] py-20 border-b border-[#E4D3C8]/50 scroll-mt-32">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
          ...
          <div className="text-center max-w-xl mx-auto mb-16">
            ...
            <h2 className="font-display text-[28px] sm:text-[34px] font-medium text-[#402312] mt-2 leading-tight">
              Soins <em className="font-display italic text-[#573119] font-normal">Capillaires</em>
            </h2>
            <p className="font-body text-[14px] font-light text-[#6E4226] mt-2 leading-relaxed">
      ...
      {/* SECTION 6: ACCESSOIRES (Background #F8F0EB - soft crème) */}
      <section id="accessoires" className="bg-[#F8F0EB] py-20 border-b border-[#E4D3C8]/50 scroll-mt-32">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
          ...
          <div className="text-center max-w-xl mx-auto mb-16">
            ...
            <h2 className="font-display text-[28px] sm:text-[34px] font-medium text-[#402312] mt-2 leading-tight">
              Accessoires <em className="font-display italic text-[#573119] font-normal">Artisanaux</em>
            </h2>
            <p className="font-body text-[14px] font-light text-[#6E4226] mt-2 leading-relaxed">
      ...
      {/* SECTION 7: FAQ MINI BLOCK (Background #FFFAFA) */}
      <section className="bg-[#FFFAFA] py-20 border-b border-[#E4D3C8]/50">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8">
          ...
          <div className="text-center max-w-xl mx-auto mb-16">
            ...
            <h2 className="font-display text-[28px] sm:text-[34px] font-medium text-[#402312] mt-2 leading-tight">
              Aide &amp; <em className="font-display italic text-[#573119] font-normal">Conseils Boutique</em>
            </h2>
            <div className="w-12 h-[1px] bg-[#C8A893] mx-auto mt-4"></div>
          </div>
