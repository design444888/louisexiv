...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'p3',
    name: "Le Shampoing Doux",
    category: "Soins Capillaires",
    categorySlug: "soins",
    description: " amande et fleur d'oranger.",
    price: 54,
    image: "Photos/shampoing-louise-xiv.webp",
    rating: 5.0,
    volumeOrSize: "50ml",
    details: [
      "Shampoing doux - Louise XIV® ",
       "Photo shampoing doux",
       "Aux extraits d’ortie, sauge, cresson, arnica et romarin,",
       "Le shampoing doux Louise XIV® a été conçu pour nettoyer en douceur les cheveux, grâce à sa base lavante d’origine naturelle. La diversité et complémentarité des actifs végétaux du shampoing doux Louise XIV® en font un shampoing tout à fait unique. Les extraits d’ortie- sauge- cresson- arnica et romarin possèdent chacun des propriétés et activités complémentaires tonifiantes stimulantes et purifiantes. Il est un parfait allié pour entretien le cheveu coloré en Louise XIV®.",
       "Photo shampoing doux ",

       "Liste des ingrédients : CAPRYLYL/CAPRYL GLUCOSIDE - COCAMIDOPROPYL BETAINE - SIMMONDSIA CHINENSIS SEED OIL - ISOAMYL LAURATE - GLYCERIN - DECYL GLUCOSIDE - PARFUM - SODIUM BICARBONATE - CARRAGEE NAN - GLUCONOLACTONE - SODIUM CHLORIDE - CITRIC ACID - SODIUM BEN ZOATE - TOCOPHEROL - HELIANTHUS ANNUUS SEED OIL - URTICA DIOICA LEAF ",
       "EXTRACT - NASTURTIUM OFFICINALE LEAF/STEM EXTRACT - ARNICA CHAMIS SONIS FLOWER EXTRACT - SALVIA OFFI CINALIS LEAF EXTRACT - ROSMARINUS ",
       "OFFICINALIS LEAF EXTRACT - CALCIUM GLUCONATE",
