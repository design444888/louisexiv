...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-[#C8A893]/50 bg-[#FFFAFA]/60 shadow-none backdrop-blur-md">
      {showCartAlert && (
        <div className="absolute top-full left-1/2 z-50 mt-4 -translate-x-1/2 rounded-none bg-[#C8A893] px-4 py-2 font-body text-[13px] tracking-wide text-[#FFFAFA] shadow-none animate-fade-in">
      ...
      <div className="mx-auto flex h-20 max-w-[1200px] items-center justify-between px-6 md:grid md:grid-cols-3 md:px-8">
        ...
        <nav className="relative hidden h-full items-center justify-center gap-8 md:flex">
          ...
          >
            <Link
              href="/boutique"
              className={`flex cursor-pointer items-center gap-1 py-2 font-body text-[13px] font-semibold uppercase tracking-[0.15em] transition-colors hover:text-[#402312] ${pathname.startsWith('/boutique') || activeDropdown === 'boutique' ? 'text-[#402312] underline underline-offset-[6px]' : 'text-[#573119]'}`}
            >
              Boutique
              <ChevronDown
                size={14}
            ...
            <div
              className={`absolute top-full left-1/2 z-20 w-[280px] -translate-x-1/2 border border-[#E4D3C8] bg-[#F8F0EB] p-4 shadow-none before:absolute before:-top-4 before:left-0 before:h-4 before:w-full transition-all duration-200 ease-out ${
            ...
            >
              <div className="space-y-1">
                <Link
                  ...
                  className="group flex items-center gap-3 rounded-none p-2.5 text-[#402312] transition-all hover:bg-[#573119] hover:text-white"
                >
                  <Leaf size={18} strokeWidth={1.5} className="text-[#573119] transition-colors group-hover:text-white" />
                  <div className="text-left">
                    <div className="font-display text-[14px] font-medium">Colorations Naturelles</div>
                    <div className="font-body text-[11px] font-light text-[#6E4226] transition-colors group-hover:text-white">
                ...
                <Link
                  ...
                  className="group flex items-center gap-3 rounded-none p-2.5 text-[#402312] transition-all hover:bg-[#573119] hover:text-white"
                >
                  <Droplets size={18} strokeWidth={1.5} className="text-[#573119] transition-colors group-hover:text-white" />
                  <div className="text-left">
                ...
                <Link
                  ...
                  className="group flex items-center gap-3 rounded-none p-2.5 text-[#402312] transition-all hover:bg-[#573119] hover:text-white"
                >
                  <Sparkles size={18} strokeWidth={1.5} className="text-[#573119] transition-colors group-hover:text-white" />
                  <div className="text-left">
                ...
                <div className="my-1 border-t border-[#E4D3C8]/50 pt-1.5">
                  <Link
                    href="/boutique"
                    onClick={() => setActiveDropdown(null)}
                    className="group flex items-center gap-3 rounded-none p-2.5 font-body text-[12px] font-semibold uppercase tracking-wider text-[#402312] transition-all hover:bg-[#573119] hover:text-white"
                  >
                    <MoreHorizontal size={18} strokeWidth={1.5} className="text-[#573119] transition-colors group-hover:text-white" />
          ...
          >
            <Link
              href="/conseils"
              className={`flex cursor-pointer items-center gap-1 py-2 font-body text-[13px] font-semibold uppercase tracking-[0.15em] transition-colors hover:text-[#402312] ${pathname.startsWith('/conseils') || activeDropdown === 'conseils' ? 'text-[#402312] underline underline-offset-[6px]' : 'text-[#573119]'}`}
            >
              Conseils
              <ChevronDown
                size={14}
            ...
            <div
              className={`absolute top-full left-1/2 z-20 w-[240px] -translate-x-1/2 border border-[#E4D3C8] bg-[#F8F0EB] p-4 shadow-none before:absolute before:-top-4 before:left-0 before:h-4 before:w-full transition-all duration-200 ease-out ${
            ...
            >
              <div className="space-y-1 text-left">
                <Link
                  ...
                  onClick={() => setActiveDropdown(null)}
                  className="group flex items-center gap-3 rounded-none p-2 text-[#402312] transition-all hover:bg-[#573119] hover:text-white"
                >
                  <BookOpen size={16} strokeWidth={1.5} className="text-[#573119] transition-colors group-hover:text-white" />
                ...
                <Link
                  ...
                  className="group flex items-center gap-3 rounded-none p-2 text-[#402312] transition-all hover:bg-[#573119] hover:text-white"
                >
                  <HelpCircle size={16} strokeWidth={1.5} className="text-[#573119] transition-colors group-hover:text-white" />
                ...
                <Link
                  ...
                  className="group flex items-center gap-3 rounded-none p-2 text-[#402312] transition-all hover:bg-[#573119] hover:text-white"
                >
                  <MessageSquare size={16} strokeWidth={1.5} className="text-[#573119] transition-colors group-hover:text-white" />
          ...
          >
            <Link
              href="/a-propos"
              className={`flex cursor-pointer items-center gap-1 py-2 font-body text-[13px] font-semibold uppercase tracking-[0.15em] transition-colors hover:text-[#402312] ${pathname.startsWith('/a-propos') || activeDropdown === 'a-propos' ? 'text-[#402312] underline underline-offset-[6px]' : 'text-[#573119]'}`}
            >
              A Propos
              <ChevronDown
                size={14}
            ...
            >
              <div className="space-y-1 text-left">
                <Link
                  ...
                  className="group flex items-center gap-3 rounded-none p-2 text-[#402312] transition-all hover:bg-[#573119] hover:text-white"
                >
                  <Users size={16} strokeWidth={1.5} className="text-[#573119] transition-colors group-hover:text-white" />
                ...
                <Link
                  ...
                  className="group flex items-center gap-3 rounded-none p-2 text-[#402312] transition-all hover:bg-[#573119] hover:text-white"
                >
                  <Sprout size={16} strokeWidth={1.5} className="text-[#573119] transition-colors group-hover:text-white" />
                ...
                <Link
                  ...
                  className="group flex items-center gap-3 rounded-none p-2 text-[#402312] transition-all hover:bg-[#573119] hover:text-white"
                >
                  <Lightbulb size={16} strokeWidth={1.5} className="text-[#573119] transition-colors group-hover:text-white" />
                ...
                <Link
                  ...
                  className="group flex items-center gap-3 rounded-none p-2 text-[#402312] transition-all hover:bg-[#573119] hover:text-white"
                >
                  <Mail size={16} strokeWidth={1.5} className="text-[#573119] transition-colors group-hover:text-white" />
        ...
        <div className="flex items-center justify-end gap-4">
          ...
          <button
            className="relative flex items-center justify-center p-1.5 text-[#573119] transition-all hover:scale-105 hover:text-[#6E4226]"
            onClick={() => {
          ...
          >
            ...
            <span className="absolute -top-1 -right-1 flex h-4.5 w-4.5 items-center justify-center rounded-full bg-[#573119] font-body text-[9px] font-semibold text-[#FFFAFA]">
              {cartCount}
            </span>
          </button>
        </div>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 flex justify-start bg-[#402312]/60 backdrop-blur-xs transition-all duration-300 md:hidden">
          <div className="flex h-full w-[300px] flex-col justify-between overflow-y-auto bg-[#FFFAFA] p-6 shadow-2xl animate-slide-right">
            ...
            <div className="border-t border-[#C8A893]/40 pt-6 text-center font-body text-[11px] text-[#6E4226]">
